...
export const IncognitoMove = ({ activeItems }: Props) => {
  ...
  return (
    <div className="mb-4 rounded-lg border border-purple-500/30 bg-purple-900/20 p-3">
      <div className="mb-2 flex items-center gap-2 text-xs font-bold text-purple-400 uppercase">
      ...
      <div className="flex flex-wrap gap-2">
        {activeItems.map((item) => (
          <button
            ...
            className="flex cursor-pointer items-center rounded bg-purple-600/20 px-2 py-1 text-[10px] text-purple-300 transition hover:bg-purple-600 hover:text-white"
          >
