              ...
              {view === "landing" ? (
                <div className="space-y-8">
                    ...
                    <div className="flex items-start gap-4 rounded-xl border border-subtle bg-surface p-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs leading-normal text-low">
                          Al din historik og dine workspaces gemmes direkte i
                          dit eget Firebase-projekt.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4 rounded-xl border border-subtle bg-surface p-4">
                  ...
                  <button
                    ...
                    className="w-full cursor-pointer rounded-xl bg-action py-4 text-sm font-bold text-inverted shadow-lg shadow-action/20 hover:bg-action-hover active:scale-[0.98]"
                  >
                    Begynd opsætning
                  </button>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between px-1">
                      ...
                      <a
                        ...
                        className="cursor-pointer text-[10px] font-bold text-action hover:text-action-hover hover:underline"
                      >
                        Hent nøgler her
                      </a>
                    </div>
                    ...
                    <div className="flex items-center gap-3 rounded-lg border border-info/20 bg-info/10 px-3 py-2">
                      ...
                      <p className="text-[10px] leading-tight text-medium">
                        <strong className="text-info uppercase">
                          Vigtigt:
                        </strong>{" "}
                        Sørg for at vælge{" "}
